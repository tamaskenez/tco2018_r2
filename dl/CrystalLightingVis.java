...
public class CrystalLightingVis {
    ...
    double getScore() {
        ...
        System.out.println("n_mirrors = " + n_mirrors);
        System.out.println("n_obstacles = " + n_obstacles);
        System.out.println("n_lanterns = " + n_lanterns);
        System.out.println("n_correct_p = " + n_correct_p);
        System.out.println("n_correct_s = " + n_correct_s);
        System.out.println("n_incorrect = " + n_incorrect);
      ...
      try {
        ...
        if (proc != null) {
            ...
            try {
                ...
                addFatalError("Failed to get result from placeItems: " + e);
                return invalidScore;
            }
